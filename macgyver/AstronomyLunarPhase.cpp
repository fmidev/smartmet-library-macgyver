...
double lunar_phase(const Fmi::DateTime& utc)
{
  try
  {
    ...
    double L1 = ((270.43416400000001 + 481267.88309999998 * T) - 0.0011329999999999999 * d15) +
                1.9E-06 * d16;
    ...
    double OM = (259.18327499999998 - 1934.1420000000001 * T) + 0.002078 * d15 +
                2.2000000000000001E-06 * d16;
    ...
    double LunarLong =
        ((((((((((((((((((L1 + 6.2887500000000003 * sin(M1) + 1.2740180000000001 * sin(d17 - M1) +
                   ...
                   0.0079100000000000004 * sin((M - M1) + d17) * d7 -
                   0.006783 * sin(d17 + M) * d7) +
             ...
             0.0017730000000000001 * sin((M1 + d17) - d19) -
             0.0015950000000000001 * sin(d19 + d17)) +
    ...
    double d4 =
        (((((((5.1281889999999999 * sin(F) + 0.28060600000000002 * sin(M1 + F) +
               ...
               0.055412999999999997 * sin((d17 + F) - M1) +
               0.046272000000000001 * sin(d17 - F - M1) + 0.032572999999999998 * sin(d17 + F) +
               0.017198000000000001 * sin(d18 + F) + 0.0092669999999999992 * sin((d17 + M1) - F) +
               0.0088229999999999992 * sin(d18 - F) +
           ...
           0.00133 * sin(F - d) + 0.001106 * sin(F + 3 * M1) +
           0.0010200000000000001 * sin(d21 - F) + 0.00083299999999999997 * sin((F + d21) - M1) +
           0.00078100000000000001 * sin(M1 - 3 * F) +
           0.00067000000000000002 * sin((F + d21) - d18) +
           0.00060599999999999998 * sin(d17 - 3 * F) +
